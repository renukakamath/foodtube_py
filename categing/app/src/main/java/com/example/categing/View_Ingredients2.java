...
public class View_Ingredients2 extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response=(JsonResponse) View_Ingredients2.this;
        String q = "/view_ingredients?rid="+MYProfile.vid;
        q=q.replace(" ","%20");
        JR.execute(q);
