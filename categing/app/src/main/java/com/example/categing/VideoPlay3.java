...
public class VideoPlay3 extends Activity {
...
//		getSupportActionBar().hide(); // hide the title bar
		...
		try {
			...
			String path = "http://" + IPSettings.text + "/" + DIetMode.video;
...
//			vv.start();
	...
	public void playvideo(String videopath) {
	    ...
	    try {
	        progressDialog = ProgressDialog.show(VideoPlay3.this, "",
	                "Buffering video...", false);
	        progressDialog.setCancelable(true);
	        getWindow().setFormat(PixelFormat.TRANSLUCENT);

	        mediaController = new MediaController(VideoPlay3.this);
...
//	        });
	...
	public void onBackPressed()
	{
		...
		super.onBackPressed();
		Intent b=new Intent(getApplicationContext(), DIetMode.class);
		startActivity(b);
	}
