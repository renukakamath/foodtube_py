...
public class VideoPlay5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			String path = "http://" + IPSettings.text + "/" + getIntent().getExtras().getString("vdo");
...
//			vv.start();
	...
	public void playvideo(String videopath) {
	    ...
	    try {
	        progressDialog = ProgressDialog.show(VideoPlay5.this, "",
	                "Buffering video...", false);
	        progressDialog.setCancelable(true);
	        getWindow().setFormat(PixelFormat.TRANSLUCENT);

	        mediaController = new MediaController(VideoPlay5.this);
