...
public class View_Ingredients3 extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JR.json_response=(JsonResponse) View_Ingredients3.this;
        String q = "/view_ingredients?rid="+DIetMode.vid;
        q=q.replace(" ","%20");
        JR.execute(q);
